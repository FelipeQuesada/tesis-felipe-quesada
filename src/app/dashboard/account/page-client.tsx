...
export default function AccountPage() {
  ...
  // Redirigir profesores a su p?gina de cuenta
  useEffect(() => {
  ...
  // Si no est? logueado, mostrar p?gina amigable
  if (!user) {
    return (
      <>
        <PageHeader title="Mi Cuenta" />
  ...
  return (
    <>
      ...
      <main style={{ paddingBottom: '180px', padding: '1rem' }}>
        {/* Secci?n de Perfil */}
        <Link href="/dashboard/account/profile" style={{ textDecoration: 'none', color: 'inherit' }}>
          <div
